...
| Synth presets | 35 factory patches across eight genres (Schranz, Drum & Bass, Techno, Trance, House, Hardstyle, Dubstep), browsed by category in the synth editor. Save your own with `Save...`; they land in `~/Music/Eurydice/Presets/Synth` as one small XML file each and join the browser under *User* |
